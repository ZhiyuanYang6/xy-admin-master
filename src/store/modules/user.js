...
const user = {
  state: {
    ...
    // routers: JSON.parse(window.sessionStorage.getItem('routers')),
    routers: [
      ...
      },
      {
        ...
        children: [{
          ...
          },
          {
            ...
            children: [
              { path: '/ptzygl', meta: { title: '普通资源管理', icon: 'icon-ziyuanguanli' } },
              { path: '/sxzygl', meta: { title: '树形资源管理', icon: 'icon-xitongguanli1' } },
            ]
          },
          {
            path: '/qxgl/cqxgl',
        ...
        children: [
          { path: '/index', icon: 'example', meta: { title: '系统管理' } },
          {
            ...
            children: [
              ...
              { path: '/shzffwcssz', meta: { title: '服务商参数设置', icon: 'example' } },
              { path: '/zshcssz', meta: { title: '商户账户设置', icon: 'example' } },
